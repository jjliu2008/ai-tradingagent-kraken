...
echo "  nohup python3 universe_scanner_agent.py --mode paper --reset-paper --strategy-mode research --use-research-universe --notional 75 --max-pos 5 --poll 60 --interval 15 > logs/agent.log 2>&1 &"
echo ""
echo "Watch the logs:"
